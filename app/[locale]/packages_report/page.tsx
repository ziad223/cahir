     ...
     <section className="pt-5 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4">
        <div className="flex mb-3">
            <Link href={`/${locale}/administration/treatment-plans`} className="btn bg-[#7451ab] text-white px-4 py-2 rounded flex items-center gap-1">
            <FaAngleRight />
          </Link>
        </div>

        <h4 className="text-lg font-bold text-gray-800 mb-4">{t('products_sub')}</h4>

        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex flex-wrap items-center gap-2 mb-4">
            <div className="bg-[#7451ab] text-white px-3 py-2 rounded text-sm">
